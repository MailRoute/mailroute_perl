package MailrouteAPI::EmailAccountAlias;
...
my @rest_api = (
	'schema:get:/api/v1/localpart_alias/schema/',
	'get:get:/api/v1/localpart_alias/',
	'list:get:/api/v1/localpart_alias/',
	'create:post:/api/v1/localpart_alias/',
	'update:put:/api/v1/localpart_alias/{id}/',
	'delete:delete:/api/v1/localpart_alias/{id}/',
);
...
sub new
{
	...
	map {
		...
		my $method_name = 'MailrouteAPI::EmailAccountAlias::' . $obj_method;
		if (!MailrouteAPI::EmailAccountAlias->can($obj_method))
		{
			no strict 'refs';
			*{$method_name} = sub {
				my ($self, $params) = @_;
