package MailrouteAPI::DomainBWList;
...
sub new
{
	...
	map {
		...
		my $method_name = 'MailrouteAPI::DomainBWList::' . $obj_method;
		if (!MailrouteAPI::DomainBWList->can($obj_method))
		{
			no strict 'refs';
			*{$method_name} = sub {
				my ($self, $params) = @_;
...
=head1 NAME
The Domain Black and White List Object
